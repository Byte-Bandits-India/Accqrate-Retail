  ...
  if (loading || !isVisible) {
    return (
      <>
        ...
        <section
          id="erpSection"
          className="px-5 max-w-[1200px] mx-auto text-center mt-2"
        >
          ...
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="flex flex-col md:flex-row items-center justify-between gap-10 mb-6"
            >
              <Skeleton
                height="20px"
                width="60%"
                className="mb-3 md:mb-0 mx-auto md:mx-0"
              />
